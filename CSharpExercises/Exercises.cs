...
namespace CSharpExercises
{
    public static class Exercises
    {
        ...
        {
            double tempF = (300 * (9.0 / 5.0)) - 459.67;
        ...
        public static double GetAverageHard(int[] grades)
        {
            //int[] grades =  [90, 88, 94];
            double sum = 0;
        ...
        public static  double GetAverageEasy(int[] grades)
        {
         ...
         public static string DrawTriangle(int number, int width)
        {
            ...
            Console.WriteLine(triangle + number);
        ...
        {
            int numOfDays = 7;
            DateTime[] nextDays = new DateTime[numOfDays];
        ...
        public static double MortgageCalculator(decimal principle, decimal rate, int years, int yearlyPayments)
        {
            ...
            if (n == 12)
            {
                double numOfPayments = y * 12;
                monthlyPayment = ((r / 1200) + (r / 1200) / (Math.Pow(1 + (r / 1200), numOfPayments) - 1)) * p;
            }
            else
            {
                double numOfPayments = y * 6;
                monthlyPayment = ((r / 600) + (r / 600) / (Math.Pow(1 + (r / 600), numOfPayments) - 1)) * p;
            }
